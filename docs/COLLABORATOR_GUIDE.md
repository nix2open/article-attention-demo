...
1. Войдите по паролю.
2. Вкладка **«Загрузка файла»** → выберите `.html` → **Загрузить и опубликовать**.

**Вариант B — скачать, отредактировать локально**

1. Нажмите **«Скачать актуальную версию»**.
2. Отредактируйте `index.html` в редакторе кода.
3. Загрузите обратно через вкладку **«Загрузка файла»**.

**Вариант C — редактировать в браузере**

1. Вкладка **«Редактор HTML»** — откроется актуальный код страницы.
2. Внесите правки (тексты, стили, настройки).
3. **Сохранить и опубликовать** — старая версия уйдёт в `archived/`.
